...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Roommate::class, mappedBy: 'user')]
    #[Ignore]
    private Collection $roommate;

    public function __construct()
    {
        $this->roommate = new ArrayCollection();
    }
     ...
     */
    public function getRoommate(): Collection
    {
    ...
    {
        if (!$this->roommate->contains($roommate)) {
            $this->roommate->add($roommate);
    ...
    {
        if ($this->roommate->removeElement($roommate)) {
            // set the owning side to null (unless already changed)
            if ($roommate->getUser() === $this) {
